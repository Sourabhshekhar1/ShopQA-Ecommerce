...
<head>
  ...
  <title>Admin Dashboard | ShopQA</title>
...
<section class="stat-grid">
  <article class="card stat-card"><span>Products</span><strong>${totalProducts}</strong></article>
  <article class="card stat-card"><span>Orders</span><strong>${totalOrders}</strong></article>
  <article class="card stat-card"><span>Users</span><strong>${totalUsers}</strong></article>
</section>
<div class="admin-actions">
  <a class="btn btn-primary" href="<c:url value='/admin?action=products'/>">Manage Products</a>
  <a class="btn" href="<c:url value='/admin?action=orders'/>">Manage Orders</a>
</div>
</main>
